...
namespace MiNET.Blocks
{
	...
	public static class BlockFactory
	{
		...
		public static Block GetBlockById(byte blockId)
		{
			...
			else if (blockId == 59) block = new Crops();
			...
			else if (blockId == 74) block = new GlowingRedstoneOre();
			else if (blockId == 75) block = new RedstoneTorchOff();
			else if (blockId == 76) block = new RedstoneTorch();
			else if (blockId == 77) block = new StoneButton();
			else if (blockId == 78) block = new TopSnow();
			...
			else if (blockId == 83) block = new SugarCane();
			...
			else if (blockId == 91) block = new JackoLantern();
			else if (blockId == 92) block = new Cake();
			else if (blockId == 93) block = new RedstoneRepeaterOff();
			else if (blockId == 94) block = new RedstoneRepeater();
			...
			else if (blockId == 106) block = new Vines();
			...
			else if (blockId == 111) block = new Lilypad();
			...
			else if (blockId == 122) block = new RedstoneLampOff();
			else if (blockId == 123) block = new RedstoneLampOn();
			...
			else if (blockId == 142) block = new Potato();
			else if (blockId == 143) block = new WoodenButton();
			else if (blockId == 144) block = new MobHead();
			else if (blockId == 145) block = new Anvil();
			else if (blockId == 146) block = new TrappedChest();
			else if (blockId == 147) block = new WeightedPressurePlateLight();
			else if (blockId == 148) block = new WeightedPressurePlateHeavy();
			else if (blockId == 151) block = new DaylightSensor();
			else if (blockId == 152) block = new RedstoneBlock();
			else if (blockId == 153) block = new NetherQuartzOre();
			...
			else if (blockId == 159) block = new StainedClay();
			else if (blockId == 161) block = new AcaciaLeaves();
			else if (blockId == 162) block = new AcaciaWood();
			...
			else if (blockId == 170) block = new HayBale();
			...
			else if (blockId == 178) block = new InvertedDaylightSensor();
