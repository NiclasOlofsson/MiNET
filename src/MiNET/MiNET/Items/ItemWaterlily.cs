...
{
	public class ItemWaterlily : ItemBlock
	{
		private static readonly ILog Log = LogManager.GetLogger(typeof (ItemWaterlily));

		public ItemWaterlily() : base(111, 0)
		{
		}
